...
class EstadoRecycleViewAdapter(private val context:Context,
                               private val estados:List<Estado>,
                               private val callback: (Estado) -> Unit): RecyclerView.Adapter<EstadoRecycleViewAdapter.VH>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        ...
        holder.itemView.setOnClickListener {
            val estado = estados[holder.adapterPosition]
            callback(estado)
        }
        return holder;
    }
...
//        holder.imgBandeira.setImageDrawable()
